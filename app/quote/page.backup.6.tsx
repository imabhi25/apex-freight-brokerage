              ...
              {currentStep === 1 && (
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                    ...
                    {/* LEFT COLUMN: CONTEXT */}
                    <div className="lg:col-span-4 flex flex-col justify-start border-b lg:border-b-0 lg:border-r border-[var(--charcoal)]/10 pb-12 lg:pb-0 lg:pr-12">
                      <div className="sticky top-32">
                        ...
                        <p className="text-[13px] font-mono tracking-[0.05em] text-[var(--charcoal)]/50 uppercase leading-relaxed max-w-[280px]">
                          Enter the origin and destination to define the required lane.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 xl:gap-x-24 gap-y-12 text-left">
                        ...
                        <div className="relative z-0 w-full group md:col-span-2 pt-2">
                          <textarea
                            ...
                            className="block w-full min-h-[120px] pt-4 pb-2 px-0 text-[15px] font-medium font-sans text-[var(--charcoal)] bg-transparent border-b border-[var(--charcoal)]/30 focus:border-[var(--maroon)] focus:ring-0 focus:outline-none transition-colors duration-500 placeholder-transparent peer resize-none [&:not(:placeholder-shown)]:border-[var(--charcoal)]/50 rounded-none"
                            placeholder=" "
                          />
                          <label className="absolute left-0 top-5 text-[12px] font-bold text-[var(--charcoal)]/60 uppercase tracking-[0.2em] font-mono transition-all duration-500 pointer-events-none peer-focus:-translate-y-[28px] peer-focus:text-[var(--maroon)] peer-focus:text-[11px] peer-[:not(:placeholder-shown)]:-translate-y-[28px] peer-[:not(:placeholder-shown)]:text-[11px] peer-[:not(:placeholder-shown)]:text-[var(--charcoal)]/80">ADDITIONAL NOTES</label>
                        </div>
                      </div>

                      {/* Nav + Submit */}
                      <div className="pt-16 pb-4 flex flex-col sm:flex-row gap-8 items-center justify-between w-full">
                        {/* Supporting Info */}
