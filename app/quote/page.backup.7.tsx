                      ...
                      <div className="pt-16 pb-4 flex flex-col sm:flex-row gap-8 items-center justify-between w-full">
                        ...
                        <div className="flex items-center gap-6 sm:gap-8 order-1 sm:order-2 w-full sm:w-auto overflow-hidden">
                          ...
                          <button
                            ...
                            className={`premium-btn group px-8 sm:px-12 py-5 sm:py-6 text-white font-bold uppercase tracking-[0.2em] text-[11px] sm:text-[12px] w-full sm:w-auto shadow-2xl ${isSubmitting || !(formData.contactName.trim() && formData.phone.trim() && formData.jobTitle.trim()) ? 'opacity-40 cursor-not-allowed' : ''}`}
                          >
                            {isSubmitting ? (
                              ...
                              <span className="relative z-10 flex items-center justify-center gap-2">
                                SUBMIT INQUIRY <ArrowRight className="w-4 h-4 group-hover:translate-x-[5px] transition-transform duration-[320ms] ease-[0.25,1,0.5,1]" />
                              </span>
                            )}
                          </button>
                        </div>
