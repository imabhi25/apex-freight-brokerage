                      ...
                      <div className="pt-16 pb-4 flex flex-col sm:flex-row gap-8 items-center justify-between w-full">
                        ...
                        <div className="flex flex-col gap-2 order-2 sm:order-1 text-center sm:text-left">
                          <p className="text-[10px] sm:text-[11px] font-mono tracking-widest text-[var(--charcoal)]/50 uppercase leading-relaxed">
                            Reviewed during business hours. Freight details remain confidential.
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-6 sm:gap-8 order-1 sm:order-2 w-full sm:w-auto overflow-hidden">
                          ...
                          <button
                            ...
                            className={`group flex items-center gap-4 text-[var(--maroon)] transition-all duration-500 ease-[0.25,1,0.4,1] hover:-translate-y-[2px] hover:scale-[1.02] hover:drop-shadow-[0_8px_16px_rgba(114,35,46,0.2)] ${isSubmitting || !(formData.contactName.trim() && formData.phone.trim() && formData.jobTitle.trim()) ? 'opacity-40 cursor-not-allowed' : ''}`}
                          >
                            {isSubmitting ? (
                              <span className="flex items-center gap-3 text-[12px] font-mono uppercase tracking-[0.25em] font-bold">
