...
export default function ServiceShowcase() {
    ...
    const cinematicEase: any = [0.25, 1, 0.4, 1]; // Smoother, high-end premium ease
    const fadeEase: any = [0.25, 1, 0.4, 1];
                ...
                {services.map((service, idx) => {
                    ...
                    return (
                        <motion.div
                            ...
                            transition={{
                                opacity: { duration: 2.0, ease: fadeEase }, // Slower, calmer crossfade
                    ...
                    {services.map((service, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`group relative overflow-hidden cursor-pointer flex flex-col justify-end backdrop-blur-md border-t border-white/10 transition-all duration-700 ease-[0.25,1,0.4,1]
                                           ${isActive
                                        ? (hoveredExploreIdx === idx
                                            ? 'bg-white shadow-[0_40px_80px_-10px_rgba(0,0,0,0.4)] z-10 scale-[1.01] -translate-y-2'
                                            : 'bg-white shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] z-10 -translate-y-1')
                                        : 'bg-[var(--charcoal)]/30 hover:bg-[var(--charcoal)]/40 hover:-translate-y-1'
                                    }`}
                                style={{
                                    height: '100%',
                                    borderRadius: '12px' // Rounded corners to match updated aesthetic
                                }}
                            >
