...
const Footer = () => {
    return (
        <footer className="w-full bg-[var(--charcoal)] px-6 pb-32 flex justify-center text-left text-white relative z-50">
            <div className="w-full max-w-6xl">
                <FadeInUpBox delay={0.2}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16 py-16 text-left">
                        {/* Branding Column */}
                ...
                <div className="border-t border-white/5 pt-6 pb-2 flex flex-col md:flex-row justify-between items-center gap-3">
                    ...
                    <p className="text-[10px] font-mono tracking-[0.2em] text-white/10 uppercase">
