                    ...
                    {isSubmitted ? (
                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                                {/* Left Column - Context */}
                                <div className="lg:col-span-4 xl:col-span-5 lg:sticky lg:top-32 pr-0 lg:pr-8 flex flex-col">
                                ...
                                {/* Right Column - Form */}
                                <div className="lg:col-span-8 xl:col-span-7 flex flex-col relative lg:pt-[10px]">
