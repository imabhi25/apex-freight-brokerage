                                ...
                                <FadeInUpBox delay={0.25}>
                                    <div className="pt-8 md:pt-12 flex flex-col items-end gap-4 w-full">
                                        <motion.button
                                            ...
                                            className={`premium-btn group py-5 md:py-6 px-8 md:px-16 w-full md:w-auto text-white font-bold uppercase tracking-[0.15em] md:tracking-[0.2em] text-[13px] md:text-[15px] font-mono shadow-2xl ${isSubmitting ? 'opacity-30 cursor-not-allowed' : ''}`}
                                        >
                                            {isSubmitting ? (
