                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                                ...
                                <div className="lg:col-span-4 xl:col-span-5 lg:sticky lg:top-32 pr-0 lg:pr-8 flex flex-col pt-2">
                                    ...
                                    <div className="mb-12">
                                        ...
                                        <ul className="space-y-4">
                                            <li className="flex items-start gap-3 text-[13px] md:text-[14px] text-[var(--charcoal)]/70">
                                                <Check className="w-4 h-4 text-[var(--maroon)] shrink-0 mt-[2px]" />
                                    ...
                                    <div className="pt-8 border-t border-[var(--charcoal)]/10 max-w-[420px]">
                                ...
                                <div className="lg:col-span-8 xl:col-span-7 flex flex-col relative pt-2">
                                    <div className="hidden lg:block absolute left-[-32px] top-0 bottom-0 w-[1px] bg-[var(--charcoal)]/10" />
                                    <div className="w-full max-w-2xl">
                                        <form onSubmit={handleSubmit} className="space-y-12 md:space-y-16" noValidate>
                                                        ...
                                                        {equipmentTypes.map((type) => (
                                                            <motion.button
                                                                ...
                                                                className={`px-6 py-3 text-[11px] font-bold tracking-[0.2em] font-mono transition-all duration-300 border rounded-none ${selectedEquipment.includes(type)
                                                                    ? 'bg-transparent text-[var(--maroon)] border-[var(--maroon)]'
                                                                    : 'bg-transparent text-[var(--charcoal)]/40 border-[var(--charcoal)]/20 hover:border-[var(--charcoal)]/40 hover:text-[var(--charcoal)]/70'
                                                                    }`}
                                                            >
                                                                {type}
                                                            </motion.button>
                                            ...
                                            <FadeInUpBox delay={0.25}>
                                                ...
                                                <p className="mt-6 md:mt-8 text-center md:text-right text-[10px] sm:text-[11px] font-mono tracking-widest text-[var(--charcoal)]/50 uppercase leading-relaxed">
                                                    Reviewed typically under 24 hours. Carrier details remain confidential.
                                                </p>
                                            </FadeInUpBox>
                                        </form>
                                    </div>
